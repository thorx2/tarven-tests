...
SpellInfo = {
  ['Default'] = {
    ['Aiding Ice Winds'] =         {id = 69,  words = 'pine apple pen',        exhaustion = 2000,  premium = false, type = 'Instant', icon = 'berserk',                mana = 10,     level = 3,  soul = 0, group = {[1] = 2000},               vocations = {1, 2, 3, 4, 5, 6, 7, 8}},
